...
public class BreastSwimming extends SwimmingMoves
{
    ...
    public static ArrayList<SwimmingMoves> registerBreastSwimmingTimes(int numberOfSwimmers)
    {
        // ArrayList to add the objects to
        ArrayList<SwimmingMoves> breastSwimmingTimes = new ArrayList<>();
        ...
        for (int i = 0; i < numberOfSwimmers; i++)
        {
            ...
            SwimmingMoves breastSwimmingTime = new SwimmingMoves(swimmerName, swimmerTime);
